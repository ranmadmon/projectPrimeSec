...
public class AppConfig {
    ...
    public DataSource dataSource() throws Exception {
        String jdbcUrl = "jdbc:mysql://" + DB_HOST + ":3306/?useSSL=false&allowPublicKeyRetrieval=true";
        ...
        dataSource.setJdbcUrl("jdbc:mysql://" + DB_HOST + ":3306/" + SCHEMA + "?useSSL=false&allowPublicKeyRetrieval=true");
